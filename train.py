...
# 注册数据集
from detectron2.data.datasets import register_coco_instances      # 用于注册数据集
from detectron2.data import MetadataCatalog

register_coco_instances("ACH_HALF_train", {},
                        r"ACH_HALF/annotations/instances_train2017.json", 
                        r"ACH_HALF/train2017")
register_coco_instances("ACH_HALF_test", {},
                        r"ACH_HALF/annotations/instances_val2017.json", 
                        r"ACH_HALF/val2017")
