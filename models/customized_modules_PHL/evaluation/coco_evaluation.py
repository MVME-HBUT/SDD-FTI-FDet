...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        metrics_recall = {
            "recall": ["AR1", "AR10", "AR100", "ARs", "ARm", "ARl"]
        }["recall"]
        ...
        # print('===========================================')
        results_recall = {
            metric_recall: float(coco_eval.stats[idx+6] * 100 if coco_eval.stats[idx+6] >= 0 else "nan")
            for idx, metric_recall in enumerate(metrics_recall)
        }
        ...
        self._logger.info(
            "Evaluation results for recall: \n" + create_small_table(results_recall)
        )
