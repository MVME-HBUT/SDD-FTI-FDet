...
class LabelEncoder(nn.Module):
    def __init__(self, category_format='norm_classes', box_format='x1y1x2y2', nr_fpn_channels=256,
        ...
        self.nr_fpn_channels = nr_fpn_channels
        ...
        # fuse
        # global + local feat
        self.conv4 = nn.Conv1d(1088, self.nr_fpn_channels, 1)
        ...
        self.bn4 = nn.LayerNorm([self.nr_fpn_channels, 1], elementwise_affine=False)
    ...
    def forward(self, x0):
        ...
        # Average
        # (T, 256)
        x = x.reshape(-1, self.R, self.nr_fpn_channels, 1).mean(dim=1).squeeze(-1)
